...
public class FrmCuadrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("GeoCalc Studio - Cuadrado");
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try {
            ...
            Cuadrado cuadrado = new Cuadrado(lado, lado, 4);

            txtArea.setText(String.format("%.2f", cuadrado.area()));
            txtPerimetro.setText(String.format("%.2f", cuadrado.perimetro()));
        } catch (NumberFormatException ex) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Ingrese un valor numerico valido en Lado.",
