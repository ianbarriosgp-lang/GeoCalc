...
public class FrmTriangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("GeoCalc Studio - Triangulo");
        ...
        pnlContenidoLayout.setHorizontalGroup(
            ...
            .addGroup(pnlContenidoLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(pnlContenidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtLadoA, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtLadoB, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtLadoC, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try {
            double ladoA = Double.parseDouble(txtLadoA.getText().trim());
            double ladoB = Double.parseDouble(txtLadoB.getText().trim());
            double ladoC = Double.parseDouble(txtLadoC.getText().trim());

            Triangulo triangulo = new Triangulo(ladoA, ladoB, ladoC, 3);

            txtArea.setText(String.format("%.2f", triangulo.area()));
            txtPerimetro.setText(String.format("%.2f", triangulo.perimetro()));
        } catch (NumberFormatException ex) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Ingrese valores numericos validos en Lado A, B y C.",
